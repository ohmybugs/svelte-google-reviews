...
<div class={cardClass} style={cardStyle}>
    <div>
        ...
        <div
            class="review-body {reviewVariant === 'testimonial' ? 'review-body-testimonial' : 'review-body-card'} {reviewBodyCardClassName} {reviewVariant === 'testimonial' ? reviewBodyTestimonialClassName : ''}"
            style="{reviewBodyCardStyle}; {reviewVariant === 'testimonial' ? reviewBodyTestimonialStyle : ''}"
        >
            <p
                class="review-text {theme === 'light' ? 'review-text-light' : 'review-text-dark'} {reviewTextClassName} {theme === 'light' ? reviewTextLightClassName : reviewTextDarkClassName}"
            ...
            {#if hasMore}
                <button
                    ...
                    class="read-more {theme === 'light' ? 'read-more-light' : 'read-more-dark'} {reviewReadMoreClassName} {theme === 'light' ? reviewReadMoreLightClassName : reviewReadMoreDarkClassName}"
                    style="{reviewReadMoreStyle}; {theme === 'light' ? reviewReadMoreLightStyle : reviewReadMoreDarkStyle}"
                >
    ...
    <div
        class="review-footer {reviewFooterClassName}"
