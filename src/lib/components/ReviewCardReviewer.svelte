<script lang="ts">
    ...
    function getFallbackBgColor(char: string): string {
        switch (char) {
            case 'a': return '#660091';
            case 'b': return '#4B53B2';
            case 'c': return '#B1004A';
            case 'd': return '#972BB0';
            case 'e': return '#0F72C8';
            case 'f': return '#094389';
            case 'g': return '#118797';
            case 'h': return '#0F7868';
            case 'i': return '#073D30';
            case 'j': return '#57922C';
            case 'k': return '#E42567';
            case 'l': return '#364852';
            case 'm': return '#295817';
            case 'n': return '#795B50';
            case 'o': return '#4A322B';
            case 'p': return '#693EB4';
            case 'q': return '#3E1796';
            case 'r': return '#E95605';
            case 's': return '#F03918';
            case 't': return '#AE230D';
            case 'u':
            case 'v': return '#647F8C';
            case 'w':
            case 'x':
            case 'y':
            case 'z':
...
<div
    class="reviewer {reviewerClassName}"
    style={reviewerStyle}
>
    <div
        class="reviewer-profile {reviewerProfileClassName}"
    ...
    <div>
        <p
            class="reviewer-name {theme === 'light' ? 'reviewer-name-light' : 'reviewer-name-dark'} {reviewerNameClassName} {theme === 'light' ? reviewerNameLightClassName : reviewerNameDarkClassName}"
            style="{reviewerNameStyle}; {theme === 'light' ? reviewerNameLightStyle : reviewerNameDarkStyle}"
        >
            {nameStr}
        </p>
